                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <a href="#" class="btn btn-responsive btn-primary btn-sm" role="button">Submit</a>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" action="#" method="post">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <a href="#" type="submit" class="btn btn-responsive btn-info btn-sm" role="button">Sign in</a>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
                        ...
                        <div class="panel panel-success" id="hidepanel6">
                            ...
                            <div class="panel-body">
                                <form role="form">
                                    ...
                                    <a href="#" type="submit" class="btn btn-responsive btn-default" role="button">Submit Button</a>
