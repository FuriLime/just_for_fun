...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/form_builder1/js/beautify-html.js') }}" ></script>
    <script src="{{ asset('assets/vendors/form_builder1/js/beautify-css.js') }}" ></script>
    <script src="{{ asset('assets/vendors/form_builder1/js/beautify.js') }}" ></script>
