        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <div class="" id="sortable1">
                            <div class="col-sm-4">
                                <div class="grid1">grid1</div>
                            </div>
                            <div class="col-sm-4">
                                <div class="grid1">grid2</div>
                            </div>
                            <div class="col-sm-4">
                                <div class="grid1">grid3</div>
                            </div>
                            <div class="col-sm-4">
                                <div class="grid1">grid4</div>
                            </div>
                            <div class="col-sm-4">
                                <div class="grid1">grid5</div>
                            </div>
                            <div class="col-sm-4">
                                <div class="grid1">grid6</div>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/html5sortable/jquery.sortable.min.js') }}" ></script>
