...
{{-- Page title --}}
@section('title')
Mail Box replay| Josh user Template</title>
...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ URL::to('user/inbox') }}">Mail Box</a>
                    </li>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="compose row">
                                                ...
                                                <input type="text" class="col-xs-9" id="to" value="zeast@joshuser.com, " tabindex="1">
                                                <div class="clear"></div>
                                    ...
                                    <tr>
                                        <td width="100%">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="col-md-4">
                                                        <a href="{{ URL::to('user/inbox') }}" class="btn btn-sm btn-primary">
                                                            <span class="livicon" data-n="external-link" data-s="12" data-c="white" data-hc="white"></span>
                                                            Send
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="{{ URL::to('user/inbox') }}" class="btn btn-sm btn-success">
                                                            <span class="livicon" data-n="briefcase" data-s="12" data-c="white" data-hc="white"></span>
                                                            Draft
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="{{ URL::to('user/inbox') }}" class="btn btn-sm btn-warning">
