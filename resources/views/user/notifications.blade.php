...
@section('header_styles')    
	...
	<link rel="stylesheet" href="{{ asset('assets/css/pages/fluid.css') }}" />
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/vendors/noty/packaged/jquery.noty.packaged.min.js') }}" ></script>
