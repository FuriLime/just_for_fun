                                        ...
                                        <table id="user" class="table table-bordered table-striped" style="clear:both">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" id="group" data-type="select" data-pk="1" data-value="5" data-source="/groups" data-title="Select group" class="editable editable-click" data-original-title="" title="">user</a>
                                                    </td>
                                                </tr>
                                                <tr>
