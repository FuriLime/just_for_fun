                    ...
                    <div class="col-md-8">
                        ...
                        <div class="featured-post-wide">
                            ...
                            <div class="featured-text relative-left">
                                ...
                                <hr>
                                <p class="text-right">
                                    <a href="{{ URL::to('user/blog_details') }}" class="btn btn-info">Read more</a>
                                </p>
                            </div>
                            <!-- /.featured-text -->
                        </div>
                            ...
                            <ul class="media-list media-xs media-dotted">
                                <li class="media">
                                    <a class="pull-left" href="#">
                                        <img data-src="holder.js/35x35/#00bc8c:#fff" width="35" class="img-circle img-responsive pull-left" height="35" alt="riot">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading">
