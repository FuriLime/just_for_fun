...
<section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ URL::to('user/inbox') }}">Email</a>
                    </li>
                                ...
                                <tbody>
                                    <tr data-messageid="1" class="unread">
                                        ...
                                        <td width="56%" class="view-message ">
                                            <a href="{{ URL::to('user/view_mail') }}">Fwd: Make changes as needed</a>
                                        </td>
                                        ...
                                        <td width="13%" class="view-message text-right">
                                            <a href="{{ URL::to('user/view_mail') }}">16:30 PM</a>
                                        </td>
                                    </tr>
                                    <tr data-messageid="2" class="unread">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Ya comin' to our July webinar?</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}"></a>
                                        </td>
                                        <td class="view-message text-right">
                                            <a href="{{ URL::to('user/view_mail') }}">June 15</a>
                                        </td>
                                    </tr>
                                    <tr data-messageid="3">
                                        <td class="inbox-small-cells">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Mobile-First Type & Layout</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="4">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">This looks like borrows page</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}"></a>
                                        </td>
                                        <td class="view-message text-right">
                                            <a href="{{ URL::to('user/view_mail') }}">June 14</a>
                                        </td>
                                    </tr>
                                    <tr data-messageid="5">
                                        <td class="inbox-small-cells">
                                    ...
                                    <tr data-messageid="6">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Analysis on Views</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}">
                                                <i class="fa fa-paperclip"></i>
                                    ...
                                    <tr data-messageid="10">
                                        ...
                                        <td class="view-message view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Make changes as needed</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="11">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Welcome back to here</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}"></a>
                                        </td>
                                    ...
                                    <tr data-messageid="12">
                                        ...
                                        <td class="view-message">
                                            <a href="{{ URL::to('user/view_mail') }}">Dolor sit amet, consectetuer adipiscing</a>
                                        </td>
                                        <td class="view-message inbox-small-cells">
                                            <a href="{{ URL::to('user/view_mail') }}">
                                                <i class="fa fa-paperclip"></i>
