...
<head>
    <title>Lock Screen | Josh user Template</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendors/formcolorloader/gradient/fort.css') }}" />
...
<body>
    ...
    <script src="{{ asset('assets/vendors/formcolorloader/gradient/fort.js') }}"></script>
    <script>
    gradient();
    </script>
