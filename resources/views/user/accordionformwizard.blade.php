                                            ...
                                            <div id="prerequisites" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    <form id="form-prerequisites">
                                                        ...
                                                        <pre>&lt;link href="{{ asset('assets/css/bootstrap.min.css') }}" rel="stylesheet"&gt;</pre>
                                                        <p>
                                                        ...
                                                        &lt;script href="{{ asset('assets/js/bootstrap.min.js') }}" &gt;&lt;/script&gt;</pre>
                                            ...
                                            <div id="addwizard" class="panel-collapse collapse awd-h" style="height: 36.400001525878906px;">
                                                <div class="panel-body">
                                                    <form id="form-addwizard">
                                                        ...
                                                        <pre>&lt;link href="{{ asset('assets/css/bootstrap.min.css') }}" rel="stylesheet"&gt;
                                                            &lt;link href="{{ asset('assets/css/acc-wizard.min.css') }}" rel="stylesheet"&gt;
                                                        </pre>
                                                        <p>and</p>
                                                        <pre>&lt;script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js" type="text/javascript"&gt;&lt;/script&gt;
                                                            &lt;script href="{{ asset('assets/js/bootstrap.min.js') }}" &gt;&lt;/script&gt;
                                                            &lt;script href="{{ asset('assets/js/acc-wizard.min.js') }}" &gt;&lt;/script&gt;
                                                        </pre>
                                                        <p>
