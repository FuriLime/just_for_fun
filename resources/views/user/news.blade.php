            ...
            <div class="col-md-12 news-page">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Older Stories go lower</a>
                            </h3>
                            ...
                            <a href="{{ URL::to('user/news_item') }}" class="news-block-btn">
                                Read more
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">U.S. surges past Canada at World Lacrosse games</a>
                            </h3>
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Futures Game: Gallo gives US 3-2 win over World</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">World Cup 2014: 11 things the tournament taught us</a>
                            </h3>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Egypt proposes Israel-Gaza ceasefire</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Hague quits as foreign secretary</a>
                            </h3>
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Murder victim's family want answers</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('user/news_item') }}">Brooks Irish shows will not go ahead</a>
                            </h3>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="{{ URL::to('user/news_item') }}">Dying patients 'bewildered by array of services'</a>
                                    </h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="{{ URL::to('user/news_item') }}">All aboard: China's railway dream</a>
                                    </h3>
                            ...
                            <div class="col-md-6">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="{{ URL::to('user/news_item') }}">Record number of data complaints made to ICO</a>
                                    </h3>
