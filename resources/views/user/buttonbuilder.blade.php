...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/icons_files/scripts.min.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/icons_files/underscore-min.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/icons_files/backbone-min.js') }}"  type="text/javascript"></script>
