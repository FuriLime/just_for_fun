...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/magnifier/css/bootstrap-magnify.min.css') }}" rel="stylesheet" />
...
@section('footer_scripts')
    ...
    <script  href="{{ asset('assets/vendors/jasny-bootstrap/js/jasny-bootstrap.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/x-editable/jquery.mockjax.js') }}"  type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/x-editable/bootstrap-editable.min.js') }}"  type="text/javascript"></script>
    <script type="text/javascript" src="{{ asset('assets/vendors/magnifier/js/bootstrap-magnify.min.js') }}" ></script>
