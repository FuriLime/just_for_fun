        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('user.events.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                </div>
            </div>
            <br />
                    ...
                    @foreach ($events as $event)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('user.events.confirm-delete', $event->id) }}" data-toggle="modal" data-target="#delete_confirm">
