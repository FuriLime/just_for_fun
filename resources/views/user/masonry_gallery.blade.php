...
@section('header_styles')    
	...
	<link href="{{ asset('assets/vendors/gallery/css/animated-masonry-gallery.css') }}" rel="stylesheet" type="text/css" />
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/vendors/gallery/scripts/jquery.isotope.min.js') }}" ></script>
    <script type="text/javascript" src="{{ asset('assets/vendors/gallery/scripts/animated-masonry-gallery.js') }}" ></script>
    <!-- Add fancyBox main JS and CSS files -->
    <script type="text/javascript" src="{{ asset('assets/vendors/gallery/fancy_box/jquery.fancybox.js') }}" ></script>
