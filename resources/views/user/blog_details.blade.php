                        ...
                        <div class="the-box no-border no-margin more-padding">
                            ...
                            <ul class="media-list media-sm media-dotted recent-post">
                                <li class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="blog-detail.html">Duis autem vel eum iriure dolor in hendrerit in</a>
                                        </h4>
                                        <p>
                                ...
                                <li class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="blog-detail.html">Nam liber tempor cum soluta nobis eleifend</a>
                                        </h4>
                                        <p>
                                            Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                        </p>
                                ...
                                <li class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="blog-detail.html">Typi non habent claritatem insitam</a>
                                        </h4>
                                        <p>
                                            Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                        </p>
                                ...
                                <li class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="blog-detail.html">Claritas est etiam processus dynamicus</a>
                                        </h4>
                                        <p>
                                            Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                        </p>
