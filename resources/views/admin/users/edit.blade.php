...
<div class="admin-edit-profile-holder">
    ...
    <div class="panel">
        ...
        <form class="form-horizontal edit-profile-form" action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Profile Image</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Email Address</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">About you</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Job Title</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Date of Birth</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Linkedin URL</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Twitter Username</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Facebook Username</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-offset-2 control-label">Google+ URL</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control">
                </div>
            </div>
