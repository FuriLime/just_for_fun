        ...
        <div class="col-lg-10 col-sm-14 col-md-14 margin_10">
            ...
            <div class="tab-content nav-tab">
              <div id="billing_overview_panel" class="tab-pane fade in active ">
                ...
                <button class="btn btn-primary text-white"><i class='glyphicon glyphicon-edit'></i><a href="{{ URL::to('admin.billing_and_invoices.edit_billing_details') }}">Edit Billing Details</a></button>
