            ...
            <section class="sidebar ">
                <div class="page-sidebar  sidebar-nav">
                    ...
                    <ul id="menu" class="page-sidebar-menu">
                        ...
                        <li {!! (Request::is('admin/datatavles')? 'class="active"' : '') !!}>
                            <a href="#">
                        ...
                        <li {!! (Request::is('admin/form_examples') || Request::is('admin/editor') || Request::is('admin/form_layout') || Request::is('admin/validation') || Request::is('admin/formelements') || Request::is('admin/form_layouts') || Request::is('admin/formwizard') || Request::is('admin/accordionformwizard') ? 'class="active"' : '') !!}>
                            <a href="#">
