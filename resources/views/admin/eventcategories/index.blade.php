        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('admin.eventcategories.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                </div>
            </div>
            <br />
                ...
                <table class="table table-bordered " id="table">
                    ...
                    @foreach ($eventcategories as $eventcategory)
                        <tr>
                            ...
                            <td>{{{ $eventcategory->channel_name }}}</td>
								<td>{{{ $eventcategory->channel_description }}}</td>
                            <td>
