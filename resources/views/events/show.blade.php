      ...
      <div class="col-sm-7 col-md-7 ">
        ...
        <div class="col-xs-12 text-left">
            <div class="a2a_kit a2a_kit_size_32 a2a_default_style">
                ...
                <a href="http://www.skyrock.com/m/blog/share.php?js=0" class="skysocial-s skyrocksocialshare_square32" title="Share on Skyrock" style="display:inline-block;text-indent:-999em;overflow:hidden;width:24px;height:24px;background:url(http://share.static.skyrock.net/img/api/skyrocksocialshare_square24.png) no-repeat 0 0 transparent;"><p style="display:none;">Share on Skyrock</p></a>
