            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="layout-image">
                        <img src="{{ asset('assets/images/layout.png') }}" class="img-responsive" />
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <img src="{{ asset('assets/images/image_12.jpg') }}" class="img-responsive">
                <p>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <img src="{{ asset('assets/images/image_11.jpg') }}" class="img-responsive">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </p>
                <p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{ asset('assets/images/authors/avatar3.jpg') }}" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{ asset('assets/images/authors/avatar2.jpg') }}" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{ asset('assets/images/authors/avatar4.jpg') }}" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
