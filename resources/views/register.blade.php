                ...
                {{--<div class="panel-body">--}}
                    {{--<form action="{{ route('signup') }}" autocomplete="off" class="form-horizontal" method="post" role="form">--}}
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--<div class="col-sm-6">--}}
                                {{--<input type="email" name="email" required class="form-control"  autocomplete="off" id="email">--}}
                                {{--<div class="form-group {{ $errors->first('email', 'has-error') }}">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                            {{--<div class="form-group">--}}
                        ...
                        {{--<div class="form-group">--}}
                            {{--<div class="col-sm-offset-4 col-sm-8">--}}
                                {{--<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Register</button>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</form>--}}
                {{--</div>--}}
