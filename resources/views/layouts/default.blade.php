        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(!Sentinel::check())
                        <li><a href="{{ URL::to('signin') }}" class="fa fa-sign-in" data-toggle="modal" onclick="javascript: window.location.href = window.location.pathname+'#tologin'">@lang('frontend.sign_in')</a></li>
