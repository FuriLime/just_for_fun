            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(!Sentinel::check())
                        ...
                        <li><a href="{{ URL::to('signin#toregister') }}" data-toggle="modal" onclick="javascript: window.location.href = window.location.pathname+'#toregister'">@lang('frontend.sign_up')</a></li>
                    @endif
